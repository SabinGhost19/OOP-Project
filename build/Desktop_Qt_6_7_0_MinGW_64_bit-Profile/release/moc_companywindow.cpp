...
constexpr auto qt_meta_stringdata_CLASSCompanyWindowENDCLASS = QtMocHelpers::stringData(
    "CompanyWindow",
    "on_AddNewProduct_clicked",
    "",
    "SendNewPrice",
    "std::string",
    "id",
...
Q_CONSTINIT const QMetaObject CompanyWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCompanyWindowENDCLASS_t,
        ...
        // method 'on_AddNewProduct_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SendNewPrice'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::string, std::false_type>,
        // method 'SendNewQuantity'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::string, std::false_type>,
...
void CompanyWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CompanyWindow *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_AddNewProduct_clicked(); break;
        case 1: _t->SendNewPrice((*reinterpret_cast< std::add_pointer_t<std::string>>(_a[1]))); break;
        case 2: _t->SendNewQuantity((*reinterpret_cast< std::add_pointer_t<std::string>>(_a[1]))); break;
